...
def train_pcpnet(opt):
    ...
    for epoch in range(opt.nepoch):
        ...
        print(f'epoch: {epoch} training loss: {tot_train_loss}, tr_rmse : {np.mean(train_rmse)}, diff_cos36')
        print(f'epoch: {epoch} val loss: {tot_val_loss}, val_rmse : {np.mean(val_rmse)}, diff_cos36')
